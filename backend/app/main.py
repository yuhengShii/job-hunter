...
from backend.app.api.apply import apply_router
...
from backend.app.services.apply_runner import ApplyRunner, recover_interrupted_apply_tasks
...
_apply_runner: ApplyRunner | None = None
_scheduler: SchedulerService | None = None


def create_app(config: Config | None = None) -> FastAPI:
    global _config, _runner, _apply_runner, _scheduler
    ...
    for router in (auth_router, keywords_router, tasks_router, jobs_router, companies_router, stats_router, settings_router, site_credentials_router, apply_router):
